<template>
    <div class="rounded-t mb-0 px-4 py-3 border-0">
      <div class="mx-auto flex">
        <div class="max-w-full w-full relative flex">
          <div class="flex flex-row">
            ...
            <div class="ml-4 flex justify-center space-x-2">
              ...
              <span class="inline-flex items-center rounded-md bg-teal-100 px-2 py-1 my-1 text-sm font-medium text-teal-700 dark:bg-teal-400/10 dark:text-teal-400">Directly Incurred</span>
              ...
              <span class="inline-flex items-center rounded-md bg-orange-100 px-2 py-1 my-1 text-sm font-medium text-orange-700 dark:bg-orange-400/10 dark:text-orange-400">Voluntary</span>
              <span class="inline-flex items-center rounded-md bg-indigo-100 px-2 py-1 my-1 text-sm font-medium text-indigo-700 dark:bg-indigo-400/10 dark:text-indigo-400">JobsOC</span>
            </div>
          </div>
          <Listbox as="div" class="px-3 ml-auto" v-model="selectedYear" @update:model-value="changeFY(selectedYear)">
            <div class="relative">
              <ListboxButton class="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-600 sm:text-sm sm:leading-6">
              ...
              <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
                <ListboxOptions class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-gray-300 ring-opacity-5focus:outline-none sm:text-sm">
          ...
          <ul class="flex flex-row list-none">
            <li class="nav-item">
              <button class="p-1.5 -mr-4 flex items-center text-xs uppercase font-bold leading-snug hover:opacity-75" v-on:click="unallocated()">
            ...
            <li class="nav-item">
              <button class="p-1.5 flex items-center text-xs uppercase font-bold leading-snug hover:opacity-75" v-on:click="create()">
                <i class="fas fa-plus text-lg leading-9 opacity-75 text-slate-700"></i>
              </button>
            </li>
            <li class="nav-item">
              <button class="p-1.5 flex items-center text-xs uppercase font-bold leading-snug hover:opacity-75" v-on:click="exportCSV()">
